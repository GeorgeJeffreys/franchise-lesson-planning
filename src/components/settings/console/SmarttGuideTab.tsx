...
/**
 * Admin "SMARTT objective guide" sub-section. A faithful clone of
 * {@link import('./AiGuideTab').AiGuideTab}. Shows the active guide version (when
 ...
 * there is no inline editing. Each upload POSTs a new immutable version to
 * `/api/smartt-objective-guide`, then refreshes.
 *
 * When no version exists, the objective checker uses a built-in default guide;
 * the UI says so and the preview is omitted.
 */
